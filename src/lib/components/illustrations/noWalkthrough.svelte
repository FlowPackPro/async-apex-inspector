					...
					<g transform="translate(91.000000, 147.000000)">
						...
						<g>
							...
							<path
								...
								stroke-linejoin="round"
							></path>
							<circle vector-effect="non-scaling-stroke" class="slds-illustration__fill-primary" cx="146" cy="10" r="3"
							></circle>
							<circle vector-effect="non-scaling-stroke" class="slds-illustration__fill-primary" cx="146" cy="86" r="3"
							></circle>
							<circle vector-effect="non-scaling-stroke" class="slds-illustration__fill-primary" cx="10" cy="10" r="3"
							></circle>
							<circle vector-effect="non-scaling-stroke" class="slds-illustration__fill-primary" cx="10" cy="86" r="3"
							></circle>
						</g>
